    ...
    var body: some View {
        ScrollView{
            ...
            HStack{
                ...
                Text("We have a Facebook and Instagram page feel free to message us or report bugs on there.")
                Spacer()
            }.padding()
            ...
            HStack{
                Image(systemName: "server.rack")
                    .imageScale(.large)
                    .frame(width: 40, height: 40, alignment: .center)
                Text("By participating you consent to the collection and usage of your data on this app to improve the experience of PlayFest.")
                Spacer()
            }.padding()
            .frame(width: SCREEN_WIDTH)
            ...
            HStack{
                Image(systemName: "exclamationmark.triangle")
                    .imageScale(.large)
                    .frame(width: 40, height: 40, alignment: .center)
                Text("After Accepting these terms please visit the settings page and confirm or add more data to your profile.")
                Spacer()
            }.padding()
            .frame(width: SCREEN_WIDTH)
