...
struct EventMediaViolation: View {
    ...
    var body: some View {
        VStack {
            ...
            ScrollView {
                ...
                Text("This Event violates our Community Standards")
                    .font(.title2)
                    .padding(.top)
                    .bold()
                
                Text("Your event may contain content that we consider innapropriate or harmful to others on Olympsis.")
