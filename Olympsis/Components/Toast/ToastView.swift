...
#Preview {
    let metadata = NotificationMetadata(type: "event_participant_status", userId: UUID().uuidString, username: "johndoe", userImageURL:"profile-images/2CE19A66-695E-4532-98FC-E759415A9721.jpeg", postId: UUID().uuidString, postImageURL: "feed-images/44BB4716-22E6-474A-AA2F-3EC69048C4BF.jpeg", groupName: "SLCFC", timestamp: 1725008123)
